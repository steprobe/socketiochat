...
public class MainFragmentUnitTest {
    ...
    public void testCreateAndBind() {
        ...
        when(mockDependencies.createWebSocketServiceProxy()).thenReturn(mockProxy);

        attachFragment(mockDependencies);

        verify(mockDependencies, times(1)).createWebSocketServiceProxy();
        verify(mockProxy, times(1)).bind((WebSocketServiceCallback) anyObject());
    ...
    public void testRotation() {
        ...
        verify(mockDependencies, times(2)).createWebSocketServiceProxy();
        verify(mockProxy, times(2)).bind((WebSocketServiceCallback) anyObject());
